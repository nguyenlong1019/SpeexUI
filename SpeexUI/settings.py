"""
Django settings for SpeexUI project.
...
WSGI_APPLICATION = 'SpeexUI.wsgi.application'
...
JAZZMIN_SETTINGS = {
    ...
    "welcome_sign": "Welcome to SpeexUI Admin Page",

    # Copyright on the footer
    "copyright": "HK2 Team, 22 07 2025",
